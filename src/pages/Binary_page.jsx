...
const BinaryPage = () => {
  const [inputType, setInputType] = useState("Decimal"); // State to hold input type (Decimal, Octal, Hexadecimal)
        ...
        <div className="mt-[36px] w-3/4 max-w-xl bg-opacity-80 bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          {convertedValue && (
            <div className="mt-4 bg-gray-700 text-white p-4 rounded">
              <strong>Binary:</strong> {convertedValue}
            </div>
          )}
        </div>
      </section>
